        ...
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              ...
              us having to think out every case
              </Heading>
              <Text as="p">
              Adding last-minute features, whether in response to competitive pressure,
               as a developer’s pet feature,
               or on the whim of management, causes more bugs in software than almost anything else
              </Text>
